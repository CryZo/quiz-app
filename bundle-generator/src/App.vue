<template>
  <header class="flex flex-col bg-slate-900 mb-4 py-2 px-4 shadow-2xl">
    ...
    <div class="flex flex-row justify-around h-24 gap-4">
      <div @click="store.clear" class="flex border-8 border-dashed w-full border-slate-700 cursor-pointer">
      ...
      <div @click="store.downloadFile" class="flex border-8 border-dashed w-full border-slate-700 cursor-pointer">
        <div class="m-auto flex flex-col items-center justify-around">
          <span>💾</span>
